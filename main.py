...
def add_parameters():
    ...
    parser.add_argument('-ln', '--length', type=int,
                        help='Enter the length for your file name ')
    parser.add_argument('-ext', '--extension',
                        choices=['.txt', '.py', '.xml', '.css', '.html'],
                        help='Enter extension of your file')
    parser.add_argument('-con', '--content', help='Enter content '
                                                  'for your file')
    parser.add_argument('-lt', '--letters', type=int, choices=[0, 1],
                        help='Do you want to create file name with '
                             'helping letters?')
    parser.add_argument('-dg', '--digits', type=int, choices=[0, 1],
                        help='Do you want to create file name '
                             'with helping digits?')
    parser.add_argument('-a', '--action', required=True,
                        help="Choose function for working with files")
